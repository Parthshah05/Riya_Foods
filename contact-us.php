    		...
    		<div class="row">  	
	    		<div class="col-sm-8">
	    			<div class="contact-form">
				    	...
				    	<form id="main-contact-form" class="contact-form row" name="contact-form" method="post" action="<?php echo $_SERVER["PHP_SELF"];?>">
				            ...
				            <div class="form-group col-md-12">
				                <textarea name="message" id="message" required="required" class="form-control" rows="8" pattern="{1,300}" placeholder="Your Message Here"></textarea>
				            </div>                        
				            <div class="form-group col-md-12">
...
if(isset($_POST["submit"])){
    ...
    if($result===true)
    {
         ...
         $mail->SetFrom('medskyy@gmail.com', 'Feedback');
...
?>
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2019 Riya-Foods Pvt Ltd. All rights reserved.</p>
					<p class="pull-right">Designed And Creayed by <span><a target="_blank"> Parth Shah</a></span></p>
				</div>
			</div>
		</div>
