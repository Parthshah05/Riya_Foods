...
class contact
{
    ...
    public function insert($wname,$wemail,$wsub,$wmsg)
    {
        ...
        if($result){
                              ...
                              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td>
                                    ...
                                    <p>Your customer wants you to contact them.Kindly follow-up on below details.</p>
            ...
            // echo $message;
            if($mail->sendMail("mdshah9574@gmail.com", "Malav Shah", "medskyy@gmail.com", "Riya Foods Limited", "ContactUs Request", $message)){
                return true;
            }
            else{
                return false;
